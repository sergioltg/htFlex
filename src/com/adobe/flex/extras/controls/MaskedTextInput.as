...
{	
	...
	private var _saveMask:Boolean;
	
	public function get saveMask():Boolean {
		return _saveMask;
	}
	
	public function set saveMask(value:Boolean):void {
		_saveMask = value;
	}
...
//			addChildAt(new DisplayObject(),getChildIndex(textField));
    	}
    }
